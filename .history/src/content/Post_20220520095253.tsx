...
function Post({post, profile}) {
    ...
    // queryPost.data[0].attributes.categoryId
    ...
    useEffect(() => {
        ...
        async function getPosts() {
            try {
                ...
                let filteredQuery = results.filter(({attributes}) => attributes.some(({postCategory}) => results.attributes.postCategory === queryPost.data.attributes.categoryId));
