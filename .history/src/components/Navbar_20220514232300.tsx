...
function Navbar() {
  return (
    <div>
    <div className='bg-[#202020] outline outline-1 outline-[#343536] fixed h-full w-[100px] flex flex-col px-5 justify-center place-content-start space-y-10 top-0 '>
            ...
            <div className='flex flex-col space-y-10'>
              ...
              <motion.button className='tracking-widest mx-auto' whileHover={{scale: 1.1}}>
                <Link to='/Settings'>
                <div className='flex flex-row space-x-2 align-middle mx-auto'>
                  <p className='my-auto text-white'>Profile Settings</p>
                </div>
                </Link>
              </motion.button>
            </div>
